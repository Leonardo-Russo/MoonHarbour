function [RHO_LVLH, M_ctrl_DA, M_ctrl, DU, RHOd_LVLH, dist, vel, deltaState, failure_times, misalignments, ...
            renderdata, TCC, Xt_MCI, RHO_MCI, u, u_norms, f_norms, kp_store, qe0, qe, ...
            Tc, Ta, betas, gammas, acc] = parfmain(sampling_time, include_actuation, verbose, misalignment_type, state_perturbation_flag, engine_failure_flag, workspace_path)
