function [RHO_LVLH, M_ctrl_DA, M_ctrl, M_drift, DU, TU, RHOd_LVLH, dist, vel, ...
          ...
          omega_e_drift, omega_e_drift_norms, angle_e_drift, runtime] = workspace_from_data(data)
...
Tc = data.Tc;
Ta = data.Ta;
omega_e = data.omega_e;
omega_e_norms = data.omega_e_norms;
angle_e = data.angle_e;
betas = data.betas;
gammas = data.gammas;
acc = data.acc;
...
omega_e_drift = data.omega_e_drift;
omega_e_drift_norms = data.omega_e_drift_norms;
angle_e_drift = data.angle_e_drift;
