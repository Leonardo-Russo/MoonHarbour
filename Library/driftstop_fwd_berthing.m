function [value, isterminal, direction] = driftstop_fwd_berthing(~, state, gateway_radius)
...
% relative distance equal to the final distance for berthing.

global DU

if nargin < 3
    gateway_radius = 10.5e-3;
end
