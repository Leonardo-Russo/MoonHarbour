...
% provided by Dario Sanna.
    ...
    if t > checkTimes(index) && verifiedTimes(index) == 0 && stopPrediction == 0
        ...
        t0_int = t;
        tf_int = t + Delta_t;
        [tspan, ControlledRelativeState] = ode_Ham(@(t, state) NaturalControl(t, state, ppEarthMCI, ppSunMCI, muM, ...
             muE, muS, timespan, ppMoonECI, deltaE, psiM, deltaM, ppOmegadotVect, t0, ppXd, kp, DU, TU), ...
